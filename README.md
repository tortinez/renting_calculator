...
Aplicación web que evalúa, compara y visualiza el coste total y el valor presente neto (VPN/NPV) de **comprar vs alquilar (renting)** un vehículo, con:
...
### Análisis
1. **Resumen**: VPN de cada opción, recomendación automática, gráficos comparativos
2. **Equilibrio**: punto de equilibrio (meses) donde VPN son equivalentes
3. **Malla**: heatmap de diferencias VPN en matriz meses × km/año
4. **Detalles**: tabla mes a mes de flujos de caja y valores presentes

### Visualizaciones
- Barras de VPN por opción
...
```javascript
VPN = Σ(flujo_caja_mes / (1 + tasa_descuento_mensual)^mes)
```
...
| Opción | VPN | Penalización | Resultado |
|--------|-----|--------------|-----------|
| **Compra** | -37.277 € | - | |
| **Renting 10k** | -32.944 € | 70 € | |
| **Renting 15k** | -33.558 € | 0 € | ✅ **ÓPTIMO** |

**Diferencia**: +3.719 € → Renting es más económico  
